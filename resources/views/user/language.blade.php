                ...
                <div class="flex flex-col items-center justify-center p-6">
                    <div class="w-3/5">
                        <div class="flex justify-between items-center">
                            ...
                            <h3 class="text-3xl text-center uppercase font-bold text-gray-800 mb-5">Language</h3>
                            <i class='text-xl'></i>
                        </div>
                        <div class="my-4">
                            <button type="button"
                        ...
                        <div class="flex my-10 justify-center items-center flex-col">
                            <button type="submit"
                                class="py-2 w-3/5 bg-gradient-to-r from-[#28A6EF] to-[#1323A0] text-white text-md font-semibold rounded-[20px] focus:ring-4 focus:ring-blue-200 focus:outline-none focus:ring-offset-2 dark:bg-blue-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800">Customer Service</button>
                        </div>
                    </div>
